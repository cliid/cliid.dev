...
summary: 'List of supported components.'
---
...
```md
[My GitHub](https://github.com/cliid/ 'Visit my GitHub Profile!')
```
...
```md
**Visit <a href="https://github.com/cliid">My GitHub Profile</a>.**
```

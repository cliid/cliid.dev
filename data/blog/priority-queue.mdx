...
> ![](https://upload.wikimedia.org/wikipedia/commons/a/ac/Heap_add_step2.svg)
> However the heap property is still violated since 15 > 11, so we need to swap again:
> ![](https://upload.wikimedia.org/wikipedia/commons/a/ac/Heap_add_step3.svg)
...
Okay... so now I know that a priority queue uses a binary heap and what a binary heap is, but anyway, what are these operations?
